        ...
        <div class="swiper-slide">
            <article class="product__card">
                <div class="product__card--thumbnail">
                    <a class="product__card--thumbnail__link display-block" href="category/{{ $item->category->slug }}/{{ $item->slug }}">
                        <img class="product__card--thumbnail__img product__primary--img" src="{{ asset('assets/uploads/products/'.$item->image) }}" alt="product-img">
                        <img class="product__card--thumbnail__img product__secondary--img" src="{{ asset('assets/uploads/products/'.$item->image) }}" alt="product-img">
                    </a>
                    ...
                    <div class="product__add--to__card">
                        <a class="product__card--btn" id="addToCartBtn" title="Add To Card" href="{{ url('cart') }}"> Add to Cart
