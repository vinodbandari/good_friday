                        ...
                        <div class="footer__widget--inner">
                            <div class="footer__logo">
                                <a class="footer__logo--link" >
                                    <img class="footer__logo--img" src="{{ asset('bcute/img/logo/nav-log.webp') }}"
                                        alt="logo-img">
                                </a>
                            </div>
                ...
                <div class="col-lg-2 col-md-5">
                    <div class="footer__widget">
                        ...
                        <ul class="footer__widget--menu footer__widget--inner">
                            ...
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
                                    href="{{ url('my-orders') }}">My Account</a></li>
                            <li class="footer__widget--menu__list"><a class="footer__widget--menu__text"
        ...
        <div class="container">
            <div class="footer__bottom--inenr d-flex justify-content-between align-items-center">
                <p class="copyright__content mb-0"><span class="text__secondary">© 2022</span> Powered by <a
                       ...
                       >Hooktheme</a> . All Rights Reserved.</p>
                <div class="footer__payment">
                    <img src="{{ asset('bcute/img/icon/payment-img.webp') }}" alt="payment-img">
                </div>
            </div>
        </div>
    </div>
...
{{-- S C R I P T    F O R    Q U I C K   W R A P P E R    F O R    M O D A L P R O D U C T V I E W --}}

<script>
    function loadview(id, cate_id, name, description, selling_price, original_price, image, flag) {
        // alert(flag);
        $('#loadviewproductname').html(name);
        $('#loadviewproductid').val(id);
        $('#loadviewcategoryid').val(cate_id);
        $('#loadviewproductdes').html(description);
        $('#loadviewproductsp').html(selling_price);
        $('#loadviewproductop').html(original_price);
        $('#viewproductimage').attr('src', '/assets/uploads/products/' + image + '');
        $('#btnaddtocart').html(flag);
        // $('#btnbuynow').html(flag);
        // $('#loadviewsp').html(sp);
        // $('#loadviewop').html(op);
...
{{-- ----------------------------------------------------------------------------------------------------------- --}}
{{-- S C R I P T    F O R    A D D I N G   N E W    A D D R E S S   I N   M Y - A C C O U N T --}}
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit_address', function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    //   console.log(response.address.phone);
...
{{-- ------------------------------------------------------------------------------------------------------------ --}}
{{-- S O R T   B Y   L O W - H I G H , H I G H - L O W ,L A T E S T ETC   F O R     G R I D  V I E W   PRODUCTS --}}
<script>
    $(document).ready(function(e) {
        $("#sort_by").on("change", function() {
            ...
            // alert(sort_by);
            var gridview = document.getElementById('product_grid');
            var viewtype = "gridview";
            if (gridview.className === 'tab_pane') {
                viewtype = 'listview';
            }
    ...
    $(document).ready(function(e) {
        $("#gend_by").on("change", function() {
            ...
            let gend_by = $('#gend_by').val();
            let cat_id = {{ isset($category->id) ? $category->id : 0 }};
    ...
    $(document).ajaxComplete(function(event, xhr, settings) {
        let text = settings.url + '';
        let result = text.includes("listview");
        if (result == true) {
            var gridview = document.getElementById('product_grid');
            var listview = document.getElementById('product_list');



            //alert(listview.classList);
...
{{-- S O R T   B Y   L O W - H I G H , H I G H - L O W ,L A T E S T ETC   F O R     L I S T  V I E W   PRODUCTS --}}
{{-- -------------------------------------------------------------------------------------------------------------- --}}
{{-- <script>
    $(document).ready(function(e){
        $("#sort_by").on("change",function(){
...
{{-- S C R I P T   F O R    S W E E T   A L E R T S --}}
{{-- ----------------------------------------------------- --}}
...
{{-- S C R I P T    F O R   H I D I N G    M E S S A G E   A F T E R   G I V E N   S E C O N D S --}}
{{-- ------------------------------------------------------------------------------------------- --}}
