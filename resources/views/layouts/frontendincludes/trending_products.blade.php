<div class="product__section--inner trend_prod">
    <div class="row mb--n30">
        @foreach ($trending_products as $prods)
            <div class="col-lg-3 col-md-4 col-sm-6 col-6 custom-col mb-30">
                <article class="product__card">
                    <div class="product__card--thumbnail product_data">
                        ...
                        {{-- I F     P R O D U C T S    A R E  G R E A T E R   T H A N    Z E R O   THEN ADDTOCART --}}
                        @if ($prods->qty > 0)
                            {{-- A D D   T O   C A R T --}}
                    ...
                    {{-- P R O D U C T   P R I C E   D E T A I L S,   N A M E --}}
                    <div class="product__card--content text-center">
                        <h3 class="product__card--title"><a href="product-details.html">{{ $prods->name }}</a></h3>
    ...
    {{-- G O    T O    S H O P P I N G   P A G E --}}
    <div class="product__load--more text-center">
        <a class="load__more--btn primary__btn" href="{{ url('shopping') }}">Load More</a>
    </div>
