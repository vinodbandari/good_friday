            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-6 custom-col mb-30">
                <article class="product__card">
                    <div class="product__card--thumbnail product_data">
                        ...
                        <a class="product__card--thumbnail__link display-block" href="/category/{{ $prods->category->slug }}/{{ $prods->slug }}">
                        ...
                        <ul class="product__card--action">
                            <li class="product__card--action__list">
                                <a class="product__card--action__btn " onclick="loadview(`{{$prods->id}}`,`{{ $prods->name }}`,`{{ $prods->description }}`,`{{ $prods->selling_price }}`,`{{ $prods->original_price }}`,`{{ $prods->image }}`);" title="Quick View" data-bs-toggle="modal" data-bs-target="#examplemodal" href="javascript:void(0)">
                    ...
                    <div class="product__card--content text-center">
                        <h3 class="product__card--title"><a href="/category/{{ $prods->category->slug }}/{{ $prods->slug }}">{{ $prods->name }}</a></h3>
