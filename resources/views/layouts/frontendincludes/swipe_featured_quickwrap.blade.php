      ...
      <div class="modal-content quickview__main__content">
        ...
        <div class="modal-body quickview__inner">
            <div class="row row-cols-lg-2 row-cols-md-2">
                ...
                {{-- C O L U M N   F O R   I M A G E    S W I P E R S --}}
                <div class="col">
                    <div class="quickview__gallery">
                        <div class="product__media--preview  swiper">
                            <div class="swiper-wrapper">

                                {{-- B I G   I M A G E   S W I P E R S --}}
                                <div class="swiper-slide">
                                    <div class="product__media--preview__items">
                                        <a class="product__media--preview__items--link glightbox"  data-gallery="product-media-preview" >
                                            <img class="product__media--preview__items--img" id="viewproductimage" src="" alt="product-media-img">
                                        </a>
                                        {{-- <div class="product__media--view__icon">
                                            <a class="product__media--view__icon--link glightbox" id="viewproductimage"   data-gallery="product-media-preview">
