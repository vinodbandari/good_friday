                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" value="{{ old('firstname') }}" name="firstname" id="input1" placeholder="Your First Name" type="text">
                                        <span class="">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" value="{{ old('lastname') }}" name="lastname" id="input2" placeholder="Your Last Name" type="text">
                                        <span class="">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" value="{{ old('number') }}" name="number" id="input3" placeholder="Phone number" type="text">
                                        <span class="">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="contact__form--list mb-20">
                                        ...
                                        <input class="contact__form--input" value="{{ old('email') }}" name="email" id="input4" placeholder="Email" type="text">
                                        <span class="">
