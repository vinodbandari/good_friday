...
<div id="pagenotfound" class="row">
    <div class="center_column col-xs-12 col-sm-12 text-center" id="center_column">
        <div class="pagenotfound">
            <h1 class="page-title mb-20">{l s='Search Your blog' mod='smartblog'}</h1>
            <p>
                {l s='Your search for' mod='smartblog'} <strong>"{$smartsearch}"</strong>  {l s='did not yield any results.' mod='smartblog'}
            </p>
