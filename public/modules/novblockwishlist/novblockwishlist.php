...
class NovBlockWishList extends Module
{
	...
	public function __construct()
	{
		...
		$this->displayName = $this->l('Vinova Wishlist Block');
	...
	public function getContent()
	{
		...
		if (Tools::isSubmit('viewnovblockwishlist') && $id = Tools::getValue('id_product'))
		...
		if (Tools::getValue('id_customer'))
			$this->html .= $this->renderList((int)Tools::getValue('id_customer'));
	...
	public function hookDisplayProductListFunctionalButtons($params)
	{
		...
		return $this->fetch('module:novblockwishlist/views/templates/hook/novblockwishlist_button.tpl');
	}

	public function hookHeader($params)
	{
		//$this->context->controller->addCSS(($this->_path).'views/css/novblockwishlist.css', 'all');
		$this->context->controller->addJS(($this->_path).'views/js/ajax-wishlist.js');

		$this->smarty->assign(array('wishlist_link' => $this->context->link->getModuleLink('novblockwishlist', 'mywishlist')));
		...
		if ($this->context->customer->isLogged())
		{
			...
			Media::addJsDef(array(
				'wishlistProductsIdsobject' => WishList::getProductByIdCustomer($this->context->customer->id, $this->context->language->id, null, true),
				'mywishlist_url'	=> $this->context->link->getModuleLink('novblockwishlist', 'mywishlist', array(), true),
				'wishlist_heading' => $this->l('The product was successfully added to your wishlist.'),
				'goto_wishlist_text' => $this->l('Go to wishlists'),
				'continue_shopping_text' => $this->l('Continue shopping'),
	...
	public function hookRightColumn($params)
	{
		...
		return $this->fetch('module:novblockwishlist/views/templates/hook/novblockwishlist.tpl');
	}
	...
	public function hookProductActions($params)
	{
		...
		return $this->fetch('module:novblockwishlist/views/templates/hook/novblockwishlist-extra.tpl');
	}

	public function hookCustomerAccount($params)
	{
		return $this->fetch('module:novblockwishlist/views/templates/hook/my-account.tpl');
	}
	...
	*/
	...
	{
		return "<script>
			$(document).ready(function () { $('#id_customer').change( function () { $('#module_form').submit();}); });
		</script>";
	}
	...
	public function renderList($id_customer)
	{
		$wishlist = new WishList($id_customer);
		$products = WishList::getProductByIdCustomer($id_customer, $this->context->language->id);
