...
class WidgetNovProductList extends WidgetBase {

    public function getName() {
        return 'nov-product-list';
    }

    public function getTitle() {
        return __('Nov Product List', 'elementor');
    }
    ...
    protected function _registerControls() {
        $this->startControlsSection(
                'section_productlist_settings', array(
        ...
        $this->addControl(
            ...
            'default' => '',
            'condition' => array(
                'display_type' => array('slider-type-2','slider-type-3','slider-type-4'),
            ),
                )
        );
    ...
    protected function render() {
        ...
        $column = \NovElementor::get_classnumbercolumn($settings['columns'], $settings['columns'], $settings['columns_tablet'], $settings['number_row'], $settings['number_row_mobile']);
        ...
        $context->smarty->assign(
                array(
                    ...
                    'icon_title' => $settings['icon_title'] == 'yes' ? '1' : '0',
                    ...
                    'number_row_mobile' => $settings['number_row_mobile'],
        ...
        $tpl = "module:novelementor/views/templates/front/widgets/nov-product-list/{$settings['display_type']}.tpl";
