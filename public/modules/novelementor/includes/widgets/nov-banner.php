...
class WidgetNovBanner extends WidgetBase {
    ...
    public function getTitle() {
        return __('Nov Banner', 'elementor');
    }
    ...
    protected function _registerControls() {
        ...
        $this->addControl(
            ...
            'options' => array(
                ...
                'banner-type-7' => __('Banner Stype 7', 'elementor')
            )
                )
        );
        $this->addControl(
        ...
        $this->addControl(
            ...
            'default' => 'content-top',
            'options' => array(
                'content-top' => __('Content Top', 'elementor'),
                'content-bottom' => __('Content Bottom', 'elementor')
            ),
            'condition' => array(
                'display_type' => array('banner-type-2'),
            ),
                )
        );
        $this->addControl(
        ...
        $this->addControl(
            ...
            'default' => '',
            'condition' => array(
                'display_type' => array('banner-type-1', 'banner-type-4', 'banner-type-5', 'banner-type-6'),
            ),
                )
        );
        $this->addControl(
            ...
            'default' => '',
            'condition' => array(
                'display_type' => array('banner-type-1', 'banner-type-3', 'banner-type-4', 'banner-type-5', 'banner-type-6','banner-type-7'),
            ),
                )
        );
        $this->addControl(
    ...
    protected function render() {
        ...
        $tpl = "module:novelementor/views/templates/front/widgets/nov-banner/{$settings['display_type']}.tpl";
