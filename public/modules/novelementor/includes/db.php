...
class DB
{
     ...
     * @return void
     *
    public function saveEditor($post_id, $posted, $revision = self::REVISION_PUBLISH)
    {
    ...
    */
     ...
     * @return array
     *
    public function getBuilder($post_id, $revision = self::REVISION_PUBLISH)
    {
        $data = $this->getPlainEditor($post_id, $revision);
    ...
    public function getPlainEditor($post_id, $revision = self::REVISION_PUBLISH)
    {
    ...
    */
    ...
    public function getDataFromContent($content)
    {
        return empty($content) ? false : array(array(
    ...
    */
    public function iterateData($data_container, $callback)
    {
        ...
        foreach ($data_container as $element_key => $element_value) {
            $data_container[$element_key] = $this->iterateData($data_container[$element_key], $callback);
        }
