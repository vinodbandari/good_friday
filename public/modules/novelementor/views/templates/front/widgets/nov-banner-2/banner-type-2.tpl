...
<div class="nov-banner-img2 spacing-0">
    <div class="row">
        <div class="col-xl-4 col-lg-5 col-md-12 text-center d-flex align-items-center justify-content-center {$settings.display_type}">
            <div class="content-left text-right mt-md-30 pb-md-30">
        ...
        <div class="col-xl-8 col-lg-7 col-md-12 order-md-1 style4">
