...
{if isset($posts) && !empty($posts)}
    <div class="nov-bloglist slider-style-3 {$el_class}">
        <div class="block-blog clearfix">
            ...
            <div class="block_content">
                <div class="nov-blogslick-owl row novblog-box-content slider-style-3 spacing-60" data-rows="{$number_row}" data-lg="{$xl}" data-md="{$md}" data-xs="{$xs}" data-arrows="{$show_arrows}" data-dots="{$show_dots}" data-autoplay="{$autoplay}">
                    {$xy= '1'}
