    ...
    <div class="nov-bloglist slider-style-2 {$el_class}">
        <div class="block-blog clearfix">
            ...
            <div class="block_content">
                <div class="nov-blogslick-owl row novblog-box-content slider-style-2 spacing-60" data-rows="{$number_row}" data-lg="{$xl}" data-md="{$md}" data-xs="{$xs}" data-arrows="{$show_arrows}" data-dots="{$show_dots}" data-autoplay="{$autoplay}">
                    {$xy= '1'}
                        ...
                        <div class="item post-item col">
                            <div class="post-item">
                                ...
                                <div class="blog-content">
                                    ...
                                    <div class="post-desc">
                                        {$post.short_description|strip_tags:'UTF-8'|truncate:180:'...'}
                                    </div>
