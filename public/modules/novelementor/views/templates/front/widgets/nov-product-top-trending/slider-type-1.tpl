        ...
        <div class="block-product clearfix">
            <div class="block_content spacing-0">
                <div class="row d-flex align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 mb-md-30 d-flex align-items-center justify-content-center">
                        <div class="product-right mt-md-50">
                            {if isset($title) && !empty($title)}
                                <h2 class="title_block text-center mb-22 mb-md-10">
