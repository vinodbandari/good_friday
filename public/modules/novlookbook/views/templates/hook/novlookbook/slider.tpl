...
<!-- Module Lookbooks -->
{if isset($lookbooks)}
    <div class="nov-lookbook nov-lookbookslider owl-carousel owl-theme owl-loaded owl-drag {$novlookbook.class}" data-autoplay="false" data-autoplayTimeout="6000" data-items="{$novlookbook.col_lg}" data-margin="10" data-nav="true" data-dots="false" data-loop="false" data-items_md="{$novlookbook.col_md}" data-items_sm="{$novlookbook.col_sm}" data-items_xs="{$novlookbook.col_xs}">
